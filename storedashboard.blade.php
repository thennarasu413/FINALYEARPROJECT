...
<body>
    <div class="header">Store Dashboard</div>
    <div class="dashboard">
        <div class="section">
            <h2><span class="icon">&#x1F4C8;</span> View History</h2>
            <button onclick="location.href='storehistory'">Go to History</button>
        </div>
        <div class="section">
            <h2><span class="icon">&#x1F4B8;</span> Payment</h2>
            <button onclick="location.href='storepayment'">Make Payment</button>
        </div>
    </div>
</body>
</html>
