...
<body>
<form method="get" action="/cateenpayment">
    @csrf
    <div id="cateenpayment">
        <h3 class="text-center text-black pt-5">Cateen Payment</h3>
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="/storepayment" method="get">
